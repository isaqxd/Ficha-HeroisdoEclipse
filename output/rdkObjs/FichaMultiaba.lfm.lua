...
local function constructNew_frm_FM()
    ...
    obj:setDataType("Ficha_MM3e_MultiAba");
    ...
    obj.image1:setSRC("images/addIcon.png");
    ...
    obj.image2:setSRC("images/config.png");
    ...
    obj.image3:setSRC("images/helpIcon.png");
