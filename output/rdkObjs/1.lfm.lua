...
local function constructNew_frmHEROIS1_svg()
...
function newfrmHEROIS1_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmHEROIS1_svg();
      end,
      function()
...
local _frmHEROIS1_svg = {
    newEditor = newfrmHEROIS1_svg, 
    new = newfrmHEROIS1_svg, 
    name = "frmHEROIS1_svg", 
    dataType = "", 
    formType = "undefined", 
...
frmHEROIS1_svg = _frmHEROIS1_svg;
Firecast.registrarForm(_frmHEROIS1_svg);

return _frmHEROIS1_svg;
